            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-stretch">
                <input
                  ...
                  placeholder="0,00"
                  className="w-24 px-3 py-2 text-right text-sm rounded-l-lg border border-r-0 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                />
                <select
                  value={discountType}
                  onChange={(e) => { setDiscountType(e.target.value as 'fixed' | 'percent'); setDiscount(''); }}
                  className="px-2 py-2 text-sm font-medium rounded-r-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-200 cursor-pointer outline-none focus:ring-2 focus:ring-primary-500"
                >
